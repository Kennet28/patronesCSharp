...
//el mismo código de construcción AQUI podemos observar en el ejmplo como se usan estas instancias
//para pedirle datos al ususario y hacer un reporte de acuerdo a la recoleccion de estos mismos.
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // BUILDER MATERIAL DISCOGRAFICO RETORNA
